...
(function (d, h, l, m) {
    var k = {
        ...
        setWindowPostition: function (b) {
            ...
            var b = this; b.gallerylist = []; b.options.gallery ? d("#" + b.options.gallery + " a").each(function () { var a = ""; d(this).data("zoom-image") ? a = d(this).data("zoom-image") : d(this).data("image") && (a = d(this).data("image")); a == b.zoomImage ? b.gallerylist.unshift({ src: "" + a + "", title: d(this).find("img").attr("alt") }) : b.gallerylist.push({ src: "" + a + "", title: d(this).find("img").attr("alt") }) }) :
